...
Map<String, dynamic> _$BridgeClassDefToJson(
  BridgeClassDef instance,
) => <String, dynamic>{
  'type': instance.type.toJson(),
  'constructors': instance.constructors.map((k, e) => MapEntry(k, e.toJson())),

...
BridgeClassType _$BridgeClassTypeFromJson(Map<String, dynamic> json) =>
    BridgeClassType(
      ...
      $implements:
          (json[r'$implements'] as List<dynamic>?)
              ?.map((e) => BridgeTypeRef.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const <BridgeTypeRef>[],
      $with:
          (json[r'$with'] as List<dynamic>?)
              ?.map((e) => BridgeTypeRef.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const <BridgeTypeRef>[],
...
BridgeTypeSpec _$BridgeTypeSpecFromJson(Map<String, dynamic> json) =>
    BridgeTypeSpec(json['library'] as String, json['name'] as String);

Map<String, dynamic> _$BridgeTypeSpecToJson(BridgeTypeSpec instance) =>
    <String, dynamic>{'library': instance.library, 'name': instance.name};

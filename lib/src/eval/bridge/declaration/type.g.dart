...
BridgeUnresolvedTypeReference _$BridgeUnresolvedTypeReferenceFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$BridgeUnresolvedTypeReferenceToJson(
        BridgeUnresolvedTypeReference instance) =>
    <String, dynamic>{

...
BridgeParameter _$BridgeParameterFromJson(Map<String, dynamic> json) =>
    BridgeParameter(
      ...
      BridgeTypeAnnotation.fromJson(
          json['typeAnnotation'] as Map<String, dynamic>),
...
BridgeFunctionDescriptor _$BridgeFunctionDescriptorFromJson(
    ...
    BridgeFunctionDescriptor(
      ...
      (json['generics'] as Map<String, dynamic>).map(
        (k, e) =>
            MapEntry(k, BridgeGenericParam.fromJson(e as Map<String, dynamic>)),
      ),
      ...
      (json['namedParams'] as Map<String, dynamic>).map(
        (k, e) =>
            MapEntry(k, BridgeParameter.fromJson(e as Map<String, dynamic>)),
      ),
    );

Map<String, dynamic> _$BridgeFunctionDescriptorToJson(
        BridgeFunctionDescriptor instance) =>
    <String, dynamic>{

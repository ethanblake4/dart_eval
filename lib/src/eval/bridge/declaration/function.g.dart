...
BridgeFunctionDef _$BridgeFunctionDefFromJson(Map<String, dynamic> json) => BridgeFunctionDef(
      returns: BridgeTypeAnnotation.fromJson(json['returns'] as Map<String, dynamic>),
      params:
          (json['params'] as List<dynamic>).map((e) => BridgeParameter.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$BridgeFunctionDefToJson(BridgeFunctionDef instance) => <String, dynamic>{

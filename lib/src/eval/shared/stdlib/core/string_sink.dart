...
class $StringSink implements $Instance {
  ...
  /// Compile-time type specification of [$StringSink]
  static const $spec = BridgeTypeSpec('dart:core', 'StringSink');

  /// Compile-time type declaration of [$StringSink]
  static const $type = BridgeTypeRef($spec);

  /// Compile-time class declaration of [$StringSink]
  ...
  @override
  StringSink get $reified => $value;

  /// Wrap a [StringSink] in a [$StringSink]
  $StringSink.wrap(this.$value) : _superclass = $Object($value);

...
class RuntimeType {
  ...
  factory RuntimeType.fromJson(List json) {
    return RuntimeType(json[0], [for (final ta in json[1]) RuntimeType.fromJson(ta)]);
  }

  List toJson() {
    return [type, [for (final ta in typeArgs) ta.toJson()]];
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is RuntimeType && runtimeType == other.runtimeType && type == other.type && typeArgs == other.typeArgs;
...
class RuntimeTypeSet {
  ...
  factory RuntimeTypeSet.fromJson(List json) {
    return RuntimeTypeSet(json[0], Set.from(json[1]), [for (final a in json[2]) RuntimeTypeSet.fromJson(a)]);
  }
  ...
  List toJson() => [rt, types.toList(), [for (final a in typeArgs) a.toJson()]];
  ...
  @override
  int get hashCode => rt.hashCode ^ _equality.hash(types) ^ _equality.hash(typeArgs);
}
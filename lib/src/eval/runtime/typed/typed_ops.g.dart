...
abstract final class TypedOp {
  ...
  static const setCallTypeArguments = 135;
  static const eEqRS = 136;
  static const aFromR = 137;
  static const aNativeFromR = 138;
  static const fFromR = 139;
  static const fNativeFromR = 140;
  static const eFromR = 141;
  static const eNativeFromR = 142;
  static const rBoxString = 143;
  static const rUnboxString = 144;
  static const callExternal = 145;
  static const rNewBridgeSuperShim = 146;
  static const parentBridgeSuperShim = 147;
  static const rAttachBridge = 148;
  static const rRuntimeType = 149;
  static const rNewCaptureCell = 150;
  static const rReadCaptureCell = 151;
  static const writeCaptureCellRS = 152;
  static const rCreateClosure = 153;
  static const rLoadCapture = 154;
  static const callClosure = 155;
  static const enterTry = 156;
  static const rBeginAsync = 157;
  static const rAwait = 158;
  static const rReturnAsync = 159;
  static const returnAsyncNull = 160;
  static const completeJump = 161;
  static const resumeCompletion = 162;
  static const eAssertR = 163;
  static const rThrow = 164;
  static const rethrowCaught = 165;
  static const eIsTypeR = 166;
  static const rCreateRecord = 167;
  static const rLoadType = 168;
  static const rLoadTypeParameter = 169;
  static const rAssertType = 170;
  static const aLoadGlobal = 171;
  static const aSetGlobal = 172;
  static const fLoadGlobal = 173;
  static const fSetGlobal = 174;
  static const eLoadGlobal = 175;
  static const eSetGlobal = 176;
  static const rLoadGlobal = 177;
  static const rSetGlobal = 178;
  static const callHost = 179;
  static const callMethod = 180;
  static const aStringLengthR = 181;
  static const rStringConcatS = 182;
  static const aStringCodeUnitR = 183;
  static const rStringIndexA = 184;
  static const cNewList = 185;
  static const cNewMap = 186;
  static const cNewSet = 187;
  static const rMapIndexCS = 188;
  static const mapSetCSR = 189;
  static const setAddCR = 190;
  static const rBoxMap = 191;
  static const rBoxSet = 192;
  static const aListLengthR = 193;
  static const rListIndexCA = 194;
  static const listSetCAR = 195;
  static const listAppendCR = 196;
  static const rBoxList = 197;
  static const rBoxListTyped = 198;
  static const rCreateClassRA = 199;
  static const rLoadPropertyR = 200;
  static const setPropertyRS = 201;
  static const rLoadSuperR = 202;
  static const rLoadLatePropertyR = 203;
  static const setLateFinalPropertyRS = 204;
  static const rLoadThisR = 205;
  static const returnNull = 206;
  static const callVirtual = 207;
  static const jumpNotEqAB = 208;
  static const jumpNotEqFG = 209;
  static const jumpNotNeAB = 210;
  static const jumpNotNeFG = 211;
  static const jumpNotLtAB = 212;
  static const jumpNotLtFG = 213;
  static const jumpNotLteAB = 214;
  static const jumpNotLteFG = 215;
  static const jumpNotGtAB = 216;
  static const jumpNotGtFG = 217;
  static const jumpNotGteAB = 218;
  static const jumpNotGteFG = 219;
  static const jumpETrueShort = 220;
  static const jumpEFalseShort = 221;
  static const jumpShort = 222;
  static const jumpNotEqABShort = 223;
  static const jumpNotEqFGShort = 224;
  static const jumpNotNeABShort = 225;
  static const jumpNotNeFGShort = 226;
  static const jumpNotLtABShort = 227;
  static const jumpNotLtFGShort = 228;
  static const jumpNotLteABShort = 229;
  static const jumpNotLteFGShort = 230;
  static const jumpNotGtABShort = 231;
  static const jumpNotGtFGShort = 232;
  static const jumpNotGteABShort = 233;
  static const jumpNotGteFGShort = 234;

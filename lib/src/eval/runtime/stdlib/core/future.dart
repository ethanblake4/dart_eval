...
class $Future<T> implements Future<T>, $Instance {
  ...
  static const $declaration = BridgeClassDeclaration(
      _$type,
      isAbstract: false,
      constructors: {},
      methods: {
        'then': BridgeMethodDeclaration(false, BridgeFunctionDescriptor(BridgeTypeAnnotation(
            _$type, false), {}, [
              BridgeParameter('onValue', BridgeTypeAnnotation(BridgeTypeReference.type(RuntimeTypes.functionType, []), false), false)
        ], {}))
      },
      getters: {},
      setters: {},

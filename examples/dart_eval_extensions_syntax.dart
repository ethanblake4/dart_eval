  ...
  static final $declaration = BridgeClassDef(
    ...
    constructors: {
      ...
      '': BridgeConstructorDef(BridgeFunctionDef(returns: $type.annotate, params: [
        ...
        'timezoneOffset'.paramOptional(RuntimeTypes.intType.bridged)
      ]))
    },
    methods: {},
    getters: {},
    setters: {},
    fields: {
      'utcTime': BridgeFieldDef(RuntimeTypes.intType.bridged.annotate),
      'timezoneOffset': BridgeFieldDef(RuntimeTypes.intType.bridged.annotate)
    },
    wrap: true,
  );
...
class $WorldTimeTracker$bridge with $Bridge<WorldTimeTracker> implements WorldTimeTracker {
  ...
  static final $declaration = BridgeClassDef(
    ...
    methods: {
      'getTimeFor': BridgeMethodDef(
        BridgeFunctionDef(
          returns: $TimestampedTime.$type.annotate,
          params: ['country'.param(RuntimeTypes.stringType.bridged)],
          namedParams: [],
        ),
      )
    },
